...
const Home = () => {
  ...
  useEffect(() => {
    fetch("https://foodcorner-omega.vercel.app/all-users")
      .then((res) => res.json())
      .then((data) => {
        setUser(data);
      });
      ...
      <div className="container mx-auto">
        ...
        <section className="mt-20 md:p-0 p-3">
          ...
          <p className="text-2xl text-justify mt-5">
            ...
            foods to creative fusions, American food offers a range of delicious
            options for every taste preference. In this article, we will explore
            a classic American recipe that has been a favorite for generations -
            macaroni and cheese. Macaroni and cheese is a dish that is loved by
            both kids and adults alike. This creamy and cheesy pasta dish has
            been a staple of American cuisine for over a century, and its easy
            to see why. The combination of pasta, cheese, and a creamy sauce
            creates a comforting and satisfying meal that is perfect for any
            occasion.
          </p>
        ...
        <section className="mt-20 md:p-0 p-3">
          ...
          <p className="text-xl md:text-center text-justify">
            ...
            long hours, high pressure, and a focus on creativity and innovation.
          </p>
          <div className="grid md:grid-cols-2 grid-cols-1 gap-5 mt-8">
            ...
            >
              ...
              <p className="mt-2 text-justify">
                ...
                per day, including evenings, weekends, and holidays. This can be
                physically and mentally exhausting, and can leave little time
            ...
            >
              ...
              <p className="mt-2 text-justify">
                ...
                with multiple tasks and orders to manage at once. This requires
                chefs to be able to work quickly and efficiently under pressure.
              </p>
            </div>
            <div
              data-aos="fade-right"
            ...
            >
              ...
              <p className="mt-2 text-justify">
                Chefs must have a high level of attention to detail in order to
                create dishes that are not only delicious but visually appealing
                as well. This requires a keen eye for presentation and a
            ...
            >
              ...
              <p className="mt-2 text-justify">
                Chefs must be creative and innovative in order to stand out in a
                highly competitive industry. They must be able to experiment
            ...
            >
              ...
              <p className="mt-2 text-justify">
                Chefs must have a deep passion for food and cooking in order to
                be successful. They must be willing to put in the time and
                effort to constantly improve their craft, and be able to handle
