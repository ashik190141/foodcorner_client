          ...
          <div className="relative mx-auto my-20 space-y-8 bg-white p-8 shadow-[0px_0px_30px_2px_rgba(100,100,111,0.1)] dark:bg-[#18181B] md:w-[300px]">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-center pt-4">
                <Link to="/payment" state={purchase.dollar}>
                  <button className="h-10 px-5 text-black w-full rounded-md border-2 border-sky-300 font-black duration-300 dark:text-[#6CC2FB]">
                    Purchases
                  </button>
                </Link>
              </div>
